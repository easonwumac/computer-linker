...
assert(packageSmokeScript.includes('"quickstart", installedWorkspaceDir, "--dev", "--json"'), "package smoke must verify installed quickstart");
...
assert(packageSmokeScript.includes('"self-test", "--json"'), "package smoke must run installed self-test");
assert(packageSmokeScript.includes("installed self-test did not verify MCP tools/list"), "package smoke must verify installed self-test covers MCP tools/list");
