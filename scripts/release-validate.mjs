...
assert(readme.split("\n").length <= 320, "README must stay a concise first-run guide; move detailed docs under docs/");
...
assert(readme.includes("computer-linker start"), "README Quick Start must document explicit-folder startup");
assert(readme.includes("computer-linker check"), "README Quick Start must document the productized install check");
assert(readme.includes("computer-linker client setup"), "README must document the client setup command");
assert(readme.includes("computer-linker diagnose client"), "README must document the client diagnosis command");
assert(readme.includes("computer-linker here --tunnel openai --tunnel-id tunnel_"), "README must document the short OpenAI tunnel startup path");
assert(readme.includes("computer-linker here --tunnel tailscale"), "README must document the short Tailscale Funnel startup path");
assert(readme.includes("computer-linker here --tunnel cloudflare"), "README must document the short Cloudflare tunnel startup path");
