...
import {
  ...
  printCheckHelp,
  printClientHelp,
  printClientHelpTopic,
  printConfigHelp,
  printConfigHelpTopic,
  printDiagnoseHelp,
  printDoctorHelp,
  printExposeHelp,
  printExposeHelpTopic,
  printHelp,
  printHereHelp,
  printHistoryHelp,
  printInitHelp,
  ...
  printServeHelp,
  printServiceHelp,
  printServiceHelpTopic,
  printSetupHelp,
  printSetupHelpTopic,
  printStartHelp,
  printStatusHelp,
  printTunnelHelp,
  printTunnelHelpTopic,
  printVersion,
  printWorkspaceHelp,
  printWorkspaceHelpTopic,
} from "./cli-help.js";
...
async function selfTest(args: string[], commandLabel = "self-test"): Promise<void> {
  if (hasHelpFlag(args)) {
    if (commandLabel === "check") printCheckHelp();
    else printSelfTestHelp();
    return;
  }
  ...
  if (unknown.length > 0) throw new Error(`Unknown ${commandLabel} option: ${unknown[0]}`);
