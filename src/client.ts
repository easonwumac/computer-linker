...
import { createComputerLinkerComputerHelpers } from "./client-computer-helpers.js";
import type {
  ComputerLinkerComputerHelpers as ComputerLinkerComputerHelpersContract,
  ComputerLinkerOperationName as ComputerLinkerOperationNameContract,
  ComputerLinkerOperationRequest as ComputerLinkerOperationRequestContract,
} from "./client-computer-helpers.js";
...
export type ComputerLinkerOperationName = ComputerLinkerOperationNameContract;
export type ComputerLinkerOperationRequest = ComputerLinkerOperationRequestContract;
export type ComputerLinkerComputerHelpers = ComputerLinkerComputerHelpersContract;
...
export class WorkspaceLinkerClient {
  ...
  readonly computer: ComputerLinkerComputerHelpers = createComputerLinkerComputerHelpers(
    <T = unknown>(request: ComputerLinkerOperationRequest) => this.computerOperation<T>(request),
  );
