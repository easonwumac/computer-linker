...
try {
  ...
  assert.ok(doctorJson.startup.modes.some((mode) => mode.id === "tunnel-cloudflare" && mode.command === "computer-linker start <workspace-path> --dev --tunnel cloudflare"));
  assert.ok(doctorJson.startup.modes.some((mode) => mode.id === "tunnel-tailscale" && mode.command === "computer-linker start <workspace-path> --dev --tunnel tailscale"));
  assert.ok(doctorJson.startup.modes.some((mode) => mode.id === "tunnel-openai" && mode.command === "computer-linker start <workspace-path> --dev --tunnel openai --tunnel-id tunnel_..."));
  ...
  assert.match(selfTestText, /Computer Linker self-test/);
  ...
  assert.match(quickstartText, /computer-linker self-test/);
  assert.match(quickstartText, /computer-linker start .*dev_7_3.* --dev --tunnel openai --tunnel-id tunnel_test/);
  ...
  assert.match(helpText, /computer-linker start <workspace-path> --dev/);
  assert.match(helpText, /computer-linker start <workspace-path> --dev --tunnel openai\|tailscale\|cloudflare/);
  assert.match(helpText, /Start local: computer-linker start C:\\Projects\\my-app --dev/);
  ...
  assert.match(helpText, /computer-linker start C:\\Projects\\my-app --dev --tunnel cloudflare/);
  assert.match(helpText, /computer-linker start C:\\Projects\\my-app --dev --tunnel tailscale/);
  assert.match(helpText, /computer-linker start C:\\Projects\\my-app --dev --tunnel openai --tunnel-id tunnel_\.\.\./);
  assert.match(helpText, /computer-linker status/);
  assert.match(helpText, /computer-linker client setup/);
  assert.match(helpText, /computer-linker quickstart C:\\Projects\\my-app --dev/);
