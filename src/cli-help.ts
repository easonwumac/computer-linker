...
export function printConfigHelp(): void {
  console.log(
    [
      ...
      "  computer-linker config policy <workspace-id> [--json] [--allow pattern] [--deny pattern] [--allow-package-script name] [--deny-package-script name]",
      "  computer-linker config policy <workspace-id> [--max-runtime-seconds n] [--max-output-bytes n] [--allow-shell-metacharacters|--block-shell-metacharacters]",
...
export function printConfigPolicyHelp(): void {
  console.log(
    [
      ...
      "  computer-linker config policy <workspace-id> [--allow-package-script name] [--deny-package-script name]",
      "  computer-linker config policy <workspace-id> [--clear-allowed|--clear-denied|--clear-allowed-package-scripts|--clear-denied-package-scripts]",
      ...
      "  Package script policy matches package.json script names before command policy checks the package manager command.",
...
export function printAdvancedHelp(): void {
  printCliHelp(
    [
      ...
      "  computer-linker config token [rotate] [--show-token] [--json]",
      "  computer-linker config policy <workspace-id> [--json]",
      "  computer-linker config policy <workspace-id> [--allow pattern] [--deny pattern] [--allow-package-script name] [--deny-package-script name] [--max-runtime-seconds n] [--max-output-bytes n] [--allow-shell-metacharacters|--block-shell-metacharacters] [--allow-sensitive-path-metadata|--block-sensitive-path-metadata] [--allow-sensitive-path-writes|--block-sensitive-path-writes]",
      "  computer-linker config set-public-url <https-url>",
      "  computer-linker config clear-public-url",
      "  computer-linker workspace list",
