...
const computerOperationDefinitions: ComputerOperationDefinition[] = [
  ...
  { op: "package.run", category: "package", backendOperation: "package_run", target: "path", description: "Run an existing package.json script in the scope after package-script and command policy checks." },
  { op: "package.start", category: "package", backendOperation: "package_start", target: "path", description: "Start an existing package.json script as a managed process after package-script and command policy checks." },
  ...
  { op: "codex.start", category: "codex", backendOperation: "codex_start", target: "workingDirectory", description: "Start a managed Codex CLI session and return sessionId." },
  { op: "codex.read", category: "codex", backendOperation: "codex_runs", target: "sessionId", backendTarget: "workflowId", description: "Read a managed Codex session returned by codex.start, or a persisted workflow record id." },
  { op: "codex.stop", category: "codex", backendOperation: "process_stop", target: "sessionId", backendTarget: "processId", description: "Stop a managed Codex session returned by codex.start." },
  { op: "codex.list", category: "codex", backendOperation: "codex_runs", description: "List recent managed Codex sessions and persisted workflow records." },
...
const computerOperationExamples: Record<string, ComputerOperationEnvelope> = {
  ...
  "codex.read": { scope: "app", op: "codex.read", target: "proc_..." },
